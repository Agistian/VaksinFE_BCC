        ...
        <div>
            ...
            <Content style={{width:'100%', marginTop:'20px', marginBottom:'20px', justifyContent:'center', alignItems:'center'}}>
                    <div style={{width:'100%', backgroundColor:'white', marginLeft:'5%', marginRight:'5%', marginTop:'20px', borderRadius:'30px',boxShadow: '0 3px 10px rgb(0 0 0 / 0.2)', textAlign:'center'}}>
                        ...
                        <Teks2 style={{textAlign:'center', color:'black'}}>
                            Mohon perhatikan dengan seksama jadwal pelaksanaan vaksin Anda
                        </Teks2>
                        ...
                        <div style={{marginLeft:'70px', marginRight:'80px', marginTop:'40px',display:'flex', justifyContent:'center', alignItems:'center'}}>
                            <Form.Group className="col-md-12"  style={{display:'flex', flexDirection:'column'}} controlId="dob">
                                ...
                                <div>
                                    <div className='Bagi'>
                                        <Teks style={{fontSize:'18px', fontFamily:'Poppins-Regular', marginBottom: '10px'}}>Lokasi Vaksin :</Teks>
                                    </div>
                                    
                                    <Form.Control type="textarea" name="alamat"
                                        value={'Pusat Vaksinasi Sehat Sejahtera. Jl. Cemara No. 123, Kel. Mawar Indah, Kec. Bahagia, Kota Sentosa'}
                                        disabled
                                        style={{fontSize: 15,fontFamily:'Poppins-Regular', backgroundColor:'#E6E6E6', borderRadius:'20px', width:'80%'}}
                                    />
                                </div>
                        ...
                        <Teks2 style={{color:'black',marginTop:'10px', marginBottom:'50px', marginLeft:'5%'}}>
                            * Silahkan datang ke lokasi vaksinasi sesuai dengan jadwal yang telah tertera.
                        </Teks2>
                            ...
                            <Shape3 className="col-md-5" style={{display:'flex', flexDirection:'column',justifyContent:'center', alignItems:'center'}}>
                                <div style={{display:'flex'}}>
                                    ...
                                    <div style={{display:'flex', flexDirection:'column', marginLeft:'10px'}}>
                                        <div>
                                            <Teks2 style={{color:'black', fontWeight:'700'}}>Pendaftaran anda sedang diproses</Teks2>
                                        </div>
                                        <div>
                                            <Teks2>Harap menunggu, data reservasi Anda sedang kami proses.</Teks2>
                                        </div>
                                    </div>
                                </div>
                            </Shape3>
