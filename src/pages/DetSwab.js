        ...
        <div  style={{width:'100%'}}>
               ...
               <HideAppBar />
                <div style={{height:'150px'}}>
                    ...
                    <button onClick={() => navigate("/dafswab")} style={{border:'none', backgroundColor:'transparent'}}><Teks style={{fontFamily:'Poppins-Medium', fontSize:'17px'}}>Daftar SWAB </Teks></button> /
                    <button onClick={() => navigate("/detswab")} style={{border:'none', backgroundColor:'transparent'}}><Teks style={{fontFamily:'Poppins-SemiBold', fontSize:'17px'}}> Detail Booking </Teks></button>
                                                ...
                                                <MainForm>
                                                    <div style={{paddingTop:'10px'}}>        
                                                        <div style={{display:'flex', justifyContent:'left', paddingLeft:'3em', paddingBottom:'20px'}}>
                                                            ...
                                                            <Teks style={{paddingLeft:'10px', fontSize:'17px', fontFamily:'Poppins-Regular'}}><span style={{fontSize:'17px', fontFamily:'Poppins-Regular'}}>: </span>SWAB Antigen</Teks>    
                                                        </div>
                                                        ...
                                                        <div style={{display:'flex', justifyContent:'left', paddingLeft:'3em' , paddingRight:'20px', paddingBottom:'20px'}}>
                                                            ...
                                                            <Teks style={{paddingLeft:'10px', fontSize:'17px', fontFamily:'Poppins-Regular'}}><span style={{fontSize:'17px', fontFamily:'Poppins-Regular'}}>: </span>12 - 03 - 2022</Teks>    
                                                        </div>

                                                        <div style={{display:'flex', justifyContent:'left', paddingLeft:'3em' , paddingRight:'20px', paddingBottom:'20px'}}>
                                                            <Teks style={{width:'180px',paddingLeft:'5px', fontSize:'17px', fontFamily:'Poppins-Regular'}}>Jadwal </Teks>
                                                            <Teks style={{paddingLeft:'10px', fontSize:'17px', fontFamily:'Poppins-Regular'}}><span style={{fontSize:'17px', fontFamily:'Poppins-Regular'}}>: </span>10.30 WIB</Teks>    
                                                        </div>

                                                        <div style={{display:'flex', justifyContent:'left', paddingLeft:'3em' , paddingRight:'20px', paddingBottom:'20px'}}>
                                                            <Teks style={{width:'180px',paddingLeft:'5px', fontSize:'17px', fontFamily:'Poppins-Regular'}}>Biaya</Teks>
                                                            <Teks style={{paddingLeft:'10px', fontSize:'17px', fontFamily:'Poppins-Regular'}}><span style={{fontSize:'17px', fontFamily:'Poppins-Regular'}}>: </span>Rp 100.000</Teks>    
                                                        </div>
                                                    ...
                                                    <div style={{display:'flex', justifyContent:'left', paddingLeft:'3em' , paddingRight:'20px', paddingBottom:'20px', paddingTop:'10px', marginTop:'20px'}}>
                                                            ...
                                                            <Teks style={{paddingLeft:'10px', fontSize:'17px', fontFamily:'Poppins-Medium', color:'#28A470'}}><span style={{fontSize:'17px', fontFamily:'Poppins-Regular'}}>: </span>Rp 100.000</Teks>    
                                                    </div>

                                                    <MainButton onClick={() => navigate("/suksesswab")}style={{marginLeft:'10%', marginRight:'10%', fontFamily:'Poppins-Regular', marginTop:'20px'}}>Booking Sekarang</MainButton>
                                                    <br/>
                                                    <GButton onClick={() => navigate("/dafswab")} style={{marginLeft:'10%', marginRight:'10%', fontFamily:'Poppins-Regular'}}>Cancel Booking</GButton>
                                                </MainForm>
                                            </div>
                                        </div>
                                </div>
