                ...
                <div style={{paddingTop:'80px', height: '100%', width:'80%'}}>
                    ...
                    <div style={{display:'flex', justifyContent:'left'}}>
                        <div style={{width:'230px'}}>
                            ...
                            <Teks style={{marginBottom:'10px', fontFamily:'Poppins-Regular',fontSize:'17px'}}>Dokter</Teks>
                        ...
                        <div>
                            ...
                            <Teks style={{marginBottom:'10px', fontFamily:'Poppins-Regular',fontSize:'17px'}}><span style={{fontFamily:'Poppins-Regular'}}>: </span>Poli Umum (Pemeriksaan & Surat Sehat/ Buta Warna (Bhs Indonesia)</Teks>
                            ...
                            <Teks style={{marginBottom:'10px', fontFamily:'Poppins-Regular',fontSize:'17px'}}><span style={{fontFamily:'Poppins-Regular'}}>: </span>08.00 - 10.00 WIB</Teks>
                            <Teks style={{marginBottom:'10px', fontFamily:'Poppins-Regular',fontSize:'17px'}}><span style={{fontFamily:'Poppins-Regular'}}>: </span>dr. Andreas Gladwin</Teks>
                            <Teks style={{marginBottom:'10px', fontFamily:'Poppins-Medium', color:'#28A470',fontSize:'17px'}}><span style={{fontFamily:'Poppins-Regular'}}>: </span>Rp 40.000</Teks>
                        </div>
